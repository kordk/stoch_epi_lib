...
| Filename | Description | Source |
| :----- | :---------- | :---------- |
| A_confidenceregs.csv | Annotation files containing transcription factor to target (Kappa) data | DoRothERA PMID 29229604 |
...
grep -w -f de.symbols.txt ../../2019-07-10/A_confidenceregs.csv >k.de.csv

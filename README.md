...
These steps can be performed on iterative splits of the data to evaluate the performance of the model. 
...
Aggregate the epigenetic loci in a region (e.g., promoter) together:
<pre>
...
Merge the aggregated CpG regions and matching gene expression data:
<pre>

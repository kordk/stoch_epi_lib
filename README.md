...
| GSE58137_Raw_119_samplesremoved.csv | Gene expression data (V3) from the GTP Study | https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE58137 |
| ht12_v3.txt | From GEO XXX and downloaded from GEO | XX |
| sym2entrex.txt | From GEO XXX and downloaded from GEO | XX |
| regionAggregateData.csv | aggregated methylation scores generated by aggregateAssayToRegion.py in the previous step | XX |
...
mergeMatchingData.py \
     -g GSE58137_Raw_119_samplesremoved.csv \
     -d 0.05 \
     -2 \
     -p ht12_v3.txt \
     -s sym2entrex.txt \
